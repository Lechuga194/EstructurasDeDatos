...
public class PruebasLista {
	...
	public static void main(String[] args) {
		...
		lista.agregar(derecha(3));
		lista.agregarAlFinal(derecha(3));
		lista.agregar(izquierda(3));
		lista.agregarAlFinal(izquierda(3));
		lista.agregar(izquierda(3));
		lista.agregarAlFinal(derecha(3));
		lista.agregar(derecha(3));
		lista.agregarAlFinal(izquierda(3));
		lista.agregar(delante(2));
		lista.agregarAlFinal(izquierda(3));
		lista.agregarAlFinal(derecha(3));
		...
		// a.agregarOrdenadamente(5);
		// System.out.println(a);

		// a.agregarOrdenadamente(2);
		// System.out.println(a);

		// a.agregarOrdenadamente(8);
		// System.out.println(a);

		// a.agregarOrdenadamente(3);
		// System.out.println(a);

		// a.agregarOrdenadamente(4);
		// System.out.println(a);

		// a.agregarOrdenadamente(7);
		// System.out.println(a);

		// a.agregarOrdenadamente(10);
		// System.out.println(a);

		// a.agregarOrdenadamente(50);
		// System.out.println(a);

		// a.agregarOrdenadamente(1);
		// System.out.println(a);
