...
public class Lista<T> implements Listable<T> {
    ...
    public void agregarAlFinal(T elemento) throws IllegalArgumentException {
        ...
        /*
         * Si queremos agregar al final y la lista es vacia, entonces llamamos al metodo
         * agrega ya que tiene el mismo comportamiento
         */
        if (this.esVacia()) {
    ...
    private Nodo getNodo(T elem) throws NoSuchElementException {
        ...
        while (iterador.hasNext()) {
            ...
            // Dado que next() guarda el elemento y luego cambia de nodo asignamos a
            // nodoElemento antes de cambiar de nodo

            nodoElemento = iterador.siguiente;
            if (iterador.next().equals(elem)) {
                return nodoElemento;
            }
        }
        return null;
     ...
     * 
     * @param elemento Objeto que se eliminara de la lista. todo
     */
    @Override
    ...
    public T getElemento(int i) throws IndexOutOfBoundsException {
        if (i < 0 || i > this.longitud)
            throw new IndexOutOfBoundsException("Error, introduce una posicion valida");
        ...
        // BUG!!!!!!!!!! si le pides algo fuera de index regresa el ultimo elemento
    }
    ...
    public boolean equals(Object o) {
        ...
        while (iteradorOriginal.hasNext()) {
            if (!iteradorOriginal.next().equals(iteradorObjeto.next()))
                return false;
        }
        return true;
    }
