...
public class PruebasLista{
	...
	public static void main(String[] args) {
		...
		// Lista a = new Lista();
		// System.out.println(a.cabeza);
		// System.out.println(a.cola);
		// System.out.println(a.esVacia());
		// a.vaciar();
		// System.out.println(a.getTamanio());

		// System.out.println("--------------Agrega elem cuando es vacia----------------");
		// a.agregar(1);
		// System.out.println(a.cabeza);
		// System.out.println(a.cola);
		// System.out.println(a.esVacia());

		// System.out.println("--------------Agrega elem cuando no es vacia----------------");
		// a.agregar(33);
		// a.agregar(45);
		// System.out.println(a);

		// System.out.println("-------------- B Agrega elem al final cuando es vacia----------------");
		// Lista b = new Lista();
		// b.agregarAlFinal(5);
		// System.out.println(b);

		// System.out.println("-------------- B Agrega elem al final cuando no es vacia----------------");
		// b.agregarAlFinal(8);
		// b.agregarAlFinal(10);
		// System.out.println(b);

		// System.out.println("--------------Obtenemos el primer elemento de la lista----------------");
		// Lista d = new Lista();
		// //Esto da excepcion cuando intentamos obtener elementos de una lista vacia 
		// // System.out.println(d.getPrimero()); 
		// // System.out.println(d.getUltimo());

		// Integer c = (Integer)a.getPrimero();
		// System.out.println(c);
		// c = (Integer)b.getPrimero();
		// System.out.println(c);

		// System.out.println("--------------Obtenemos el ULTIMO elemento de la lista----------------");
		// c = (Integer)a.getUltimo();
		// System.out.println(c);
		// c = (Integer)b.getUltimo();
		// System.out.println(c);
		...
		// System.out.println("--------------Indice en listas----------------");
		// System.out.println(a);
		// System.out.println("Indice de 2 en a es: " + a.indiceDe(2));
		// System.out.println("Indice de 1 en a es: " + a.indiceDe(1));
		// System.out.println("Indice de 5 en a es: " + a.indiceDe(5));

		// System.out.println("--------------regresa elem en index----------------");
		// System.out.println(a);
		// System.out.println("elem en index 0 es: " + a.getElemento(0));
		// System.out.println("elem en index 1 es: " + a.getElemento(1));
		// System.out.println("elem en index 2 es: " + a.getElemento(2));
		...
		// System.out.println("--------------Copia una lista----------------");
		// Lista t = new Lista();
		// System.out.println("Lista b: " + b);
		// System.out.println("Lista m: " + m);
		...
		// System.out.println("_____COmparamos a con todas_____");
		// Lista dummy = a.copia();
		// System.out.println("a y a " + a.equals(a));
		// System.out.println("a y b " + a.equals(b));
		// System.out.println("a y d " + a.equals(d));
		// System.out.println("a y m " + a.equals(m));
		// System.out.println("a y t " + a.equals(t));
		// System.out.println("a y dummy " + a.equals(dummy));
